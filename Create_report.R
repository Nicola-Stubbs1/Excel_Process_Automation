...
setColWidths(wb, "National and Regional", cols = 1:5, widths = "auto")
...
# Adding titles and styles to workbook
...
addStyle(wb, "National and Regional",blue_font, rows = 2, cols = c(3:4),gridExpand = TRUE)
